...
Our team Kuntur created our auto driving car "Luna" to participate in the WRO Nationals 2026. It is an autonomous driving car, which was designed to detect obstacles in its surroundings and drive around it. We used module 2 raspberry pi standard camera on the top of the car. We used one stepper motor to create a car differential gear system to power the two back wheels and used a servo motor to create an axis for the two wheels in front. We taught put camera to detect liens, different objects, and walls. 
